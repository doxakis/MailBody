...
public class MailBodyTemplate
{
    ...
    public static MailBodyTemplate GetDefaultTemplate()
    {
        return new MailBodyTemplate()
            ...
            .Image(m =>
                $"<img src='{m.Src}' alt='{m.Content}' style='margin:0;Margin-bottom:15px;height:auto !important;max-width:100% !important;width:auto !important;' />")
    ...
    <tr>
        ...
        <table border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;'>
            <tbody>
            <tr>
                <td style='font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;' valign='top' bgcolor='#3498db' align='center'> <a href='" +
                m.Link +
                @"' target='_blank' style='display: inline-block; color: #ffffff; background-color: #3498db; border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; border-color: #3498db;'>" +
                m.Content + @"</a> </td>
            </tr>
            </tbody>
        </table>
